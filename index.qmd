...
::: aside
*Handbook: [https://carpentries-i18n-handbook.readthedocs.io/](https://carpentries-i18n-handbook.readthedocs.io/)
:::
...
- The upcoming Carpentries lesson format is called **"Workbench"**, being developed by Zhian Kamvar
...
## [dovetail](https://github.com/joelnitta/dovetail)
...
## [dovetail](https://github.com/joelnitta/dovetail){.scrollable}
...
## [dovetail](https://github.com/joelnitta/dovetail) design philosophy
...
::: {.fragment}	
**Promote participation in Carpentries by translating!** :grinning: :open_hands:
:::
